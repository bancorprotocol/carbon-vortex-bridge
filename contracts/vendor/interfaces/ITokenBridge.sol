...
/// @dev taken from wormhole-solidity-sdk/src/interfaces/ITokenBridge.sol (v0.1.0)
...
interface ITokenBridge {
    ...
    function completeTransferAndUnwrapETHWithPayload(bytes calldata encodedVaa) external returns (bytes memory);
